...
**An official Callr REST API v2 SDK for Node.js / TypeScript is coming soon.** Until then, generate a fully-typed client from the [OpenAPI 3.1 spec](https://api.callr.com/v2.0/openapi.json) with [OpenAPI Generator](https://openapi-generator.tech/) (requires v7.x+ for OpenAPI 3.1):

```bash
docker run --rm -v "$PWD:/local" openapitools/openapi-generator-cli generate \
  -g typescript-axios \
  -i https://api.callr.com/v2.0/openapi.json \
  -o /local/callr-v2-node
```
